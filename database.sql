...
INSERT INTO product (name, price, image, info, category_id) VALUES ('Turkoosi poolopaita',20,"Turkoosi poolo paita.jpg","Taivaan sininen ku haluat edustaa ja erottua juhlista. Pestään 40-asteisella pesuohjelmalla.",2) ;
INSERT INTO product (name, price, image, info, category_id) VALUES ('Punainen poolopaita',20,"Punainen poolo paita.jpg","Täydellinen edustava paita ei niin virallisiin juhliin. Pestään 40-asteisella pesuohjelmalla.",2) ;
...
INSERT INTO product (name, price, image, info, category_id) VALUES ('Musta liivi',28.99,"musta liivi.jpg","Ettei tule kylmä tästä väliliivi paitojen väliin 'ei sisällä ruutupaitaa mukaan'.Pestään 40-asteisella pesuohjelmalla.",3) ;
...
INSERT INTO product (name, price, image, info, category_id) VALUES ('Aluspaita',16.50,"aluspaita.jpg","Aurinkoinen, vapauttava ja täydellinen aluspaita tai normi paita kuumille kesäpäiville.",3) ;
